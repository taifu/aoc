...
class TestDay(unittest.TestCase):
    ...
    def test_part_1(self) -> None:
        self.assertEqual(8, day.solve1(self.data_example))

    def test_part_2(self) -> None:
        self.assertEqual(10, day.solve2(self.data_example_2))

    def test_solutions(self) -> None:
        self.assertEqual(day.solve1(self.data), 6800)
        self.assertEqual(day.solve2(self.data), 483)
